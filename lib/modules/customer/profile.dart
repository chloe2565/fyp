                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Profile Details
                            _ProfileInfoTile(
                                label: 'Name', value: _user!.userName),
                            const SizedBox(height: 24),
                            _ProfileInfoTile(
                                label: 'Email Address', value: _user!.userEmail),
                            const SizedBox(height: 24),
                            _ProfileInfoTile(
                                label: 'Gender',
                                value:
                                    _user!.userGender == 'M' ? 'Male' : 'Female'),
                            const SizedBox(height: 24),
                            _ProfileInfoTile(
                              ...
                              onPressed: _user != null
                                  ? () {
                                      showChangePasswordDialog(
                                        context: context,
                                        currentPasswordController: _userController
                                            .currentPasswordController,
                                        newPasswordController: _userController
