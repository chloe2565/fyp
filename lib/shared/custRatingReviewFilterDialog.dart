...
class CustomerRatingReviewFilterDialog extends StatefulWidget {
  final Map<String, String> initialServiceFilter;
  ...
  const CustomerRatingReviewFilterDialog({
    required this.onApply,
    required this.onReset,
    required this.availableServices,
    this.initialServiceFilter = const {},
  ...
  @override
  State<CustomerRatingReviewFilterDialog> createState() =>
      CustomerRatingReviewFilterDialogState();
}

class CustomerRatingReviewFilterDialogState
    extends State<CustomerRatingReviewFilterDialog> {
  Map<String, String> serviceFilter = {};
  DateTime? startDate;
  DateTime? endDate;
  ...
  void initState() {
    super.initState();
    serviceFilter = Map.from(widget.initialServiceFilter);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomDropdownMulti(
                allItems: widget.availableServices,
                selectedItems: serviceFilter,
                    ...
                    child: ElevatedButton(
                      onPressed: !hasErrors
                          ? () {
                              ...
                              widget.onApply(
                                serviceFilter: serviceFilter.isEmpty
                                    ? null
                                    : serviceFilter,
                                startDate: startDate,
                                endDate: endDate,
